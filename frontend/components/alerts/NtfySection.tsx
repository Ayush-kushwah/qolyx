...
export default function NtfySection({
  ...
  return (
    <div className="glass-panel p-5 rounded-xl border border-border bg-card flex flex-col md:flex-row items-center gap-6 select-none">
      ...
      <div className="flex-1 space-y-3">
        ...
        <h2 className="text-base font-extrabold text-foreground">Subscribe on your Mobile Device</h2>
        ...
        {/* Topic details */}
        <div className="space-y-2 pt-1.5 text-xs text-foreground">
          <div className="flex items-center gap-2">
            <Check className="h-3.5 w-3.5 text-healthy flex-shrink-0" />
            <span>
              Your personal topic: <code className="font-mono text-amber-600 dark:text-amber-400 font-bold bg-muted px-1.5 py-0.5 rounded">{topic || 'Generating...'}</code>
            </span>
          </div>
          <div className="flex items-center gap-2">
        ...
        <div className="flex flex-wrap gap-2 pt-2">
          <Button
            ...
            className="h-8 border-border text-muted-foreground hover:bg-accent hover:text-accent-foreground text-xs font-bold gap-1.5"
          >
